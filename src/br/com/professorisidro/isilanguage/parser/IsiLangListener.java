...
public interface IsiLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link IsiLangParser#cmdrepetir}.
	 * @param ctx the parse tree
	 */
	void enterCmdrepetir(IsiLangParser.CmdrepetirContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#cmdrepetir}.
	 * @param ctx the parse tree
	 */
	void exitCmdrepetir(IsiLangParser.CmdrepetirContext ctx);
	/**
